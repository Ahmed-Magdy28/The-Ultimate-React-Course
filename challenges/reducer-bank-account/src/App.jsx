...
export default function App() {
   ...
   return (
      <div className="App">
         ...
         <p>
            <button onClick={handleAddDeposit} disabled={!isActive}>
               Deposit 150
            </button>
         </p>
         <p>
            <button onClick={handleWithdrowFromDeposit} disabled={!isActive}>
               Withdraw 50
            </button>
         </p>
         <p>
            <button onClick={handleTakeLoan} disabled={!isActive}>
